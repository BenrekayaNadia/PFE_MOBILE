...
module.exports = {
	async apply(value, previousValues) {
		return new Promise(resolve => {
			console.log('\n');
			console.log(
				'TheCodingMachine React-Native Coach_privee_front initialized with success ! 🚀\n'
			);
			console.log(
				`${green(
					'                                                                    .-`    `::  \n' +
			...
			console.log(
				'- 📚 If you need to read more about this coach_privee_front : https://thecodingmachine.github.io/react-native-coach_privee_front/'
			);
			console.log(
				'- 🤕 If you have some troubles : https://github.com/thecodingmachine/react-native-coach_privee_front/issues'
			);
			console.log(
				'- ⭐ If you love this coach_privee_front, give us a star, you will be a ray of sunshine in our lives :) https://github.com/thecodingmachine/react-native-coach_privee_front'
			);
